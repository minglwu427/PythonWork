...
06052020 Change all index into using dataframe.  No more index and moved all the main function to the bottom.  This is
the final edit until production is ready.
"""
...
#file_list=os.listdir(r"C:\Users\minglwu\Desktop\Macro Scenarios\Output\fasta")

fasta_file = 'Output/fasta/C1987.fasta'
...
final_dataframe.to_excel('Output/primer/C1987_primer.xlsx')